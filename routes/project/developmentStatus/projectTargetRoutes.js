...
// router.put('/update/:id', middleware.authenticateAdmin, middleware.authorizeRole(ROLES.RNE), fileUpload.fields([{ name: 'picture', maxCount: 10 }, { name: 'updatedImage', maxCount: 10 }]), projectTargetController.handleUpdateStylingDesignById);
